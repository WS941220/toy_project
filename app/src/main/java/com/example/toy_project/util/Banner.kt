...
import kotlinx.android.synthetic.main.shared_banner.view.*
...
//    <attr name="rightButtonText" format="string"/>
    ...
    private fun init(attrs: AttributeSet?, defStyle: Int) {
        // Load attributes
        View.inflate(context, R.layout.shared_banner, this)
        ...
        contentTextView.setTextSize(TypedValue.COMPLEX_UNIT_SP, 10F)
